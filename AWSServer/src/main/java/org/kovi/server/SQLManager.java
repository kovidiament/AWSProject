...
public class SQLManager {
    ...
    public String passwordFromUsername(String user) throws SQLException
    {
        Statement statement = conn.createStatement();
        ResultSet rs =  statement.executeQuery("SELECT password FROM userPasswords WHERE name='"+user+"';");
        if(rs.next())
        {
